...
<div align="center">
	...
	<form name="form1" method="post" action="all_results.php" >		
							...
							<tr>
								...
								<table border="0" width="100%" id="table11" cellpadding="2">
									...
									<tr>
										...
										<?php
										session_start();
									    $sql="select em_name from  exam_master ".$cond." order by em_name " ; 
