				...
				if ($count>0)
				{
					...
					for($i=0;$i<$count; $i++)
					{
						...
						echo("<tr>");
							...
							//echo("<td width='98' align ='left' valign ='top'><a href='exam_category_addedit.php?mode=edit&id=".mysql_result($result,$i,"ec_id")."'>Edit</a>&nbsp; <a href='Exam_category_addedit.php?mode=delete&id=".mysql_result($result,$i,"ec_id")."'>Delete</a></td>");
